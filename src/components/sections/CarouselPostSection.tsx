        ...
        <div className="w-full max-w-[470px] mx-auto border border-[var(--color-text-main)]/20 rounded-[3px] sm:rounded-xl bg-[var(--color-bg-main)] shadow-xl shadow-[var(--color-text-main)]/5 overflow-hidden">
          ...
          <div className="flex items-center justify-between p-3 border-b border-[var(--color-text-main)]/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-sm leading-tight text-[var(--color-text-main)]">mohit_lakhara</div>
          ...
          {/* Media area */}
          <div className="relative w-full aspect-square sm:aspect-[4/5] bg-[var(--color-text-muted)]/20 overflow-hidden group">
            <div
              ref={scrollRef}
            ...
            <div className="absolute top-4 right-4 bg-black/70 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-full z-10 transition-opacity">
              {currentIndex + 1}/{carouselPost.length}
            </div>
            ...
            {currentIndex < carouselPost.length - 1 && (
              <button 
                onClick={scrollRight} 
          ...
          <div className="p-4">
            ...
            <div className="font-semibold text-sm mb-1.5 text-[var(--color-text-main)]">1,337 likes</div>
            
            <div className="text-sm text-[var(--color-text-main)]">
              <span className="font-semibold mr-2">mohit_lakhara</span>
              Creating visual stories that leave a lasting impact. Swipe to see the complete series! ✨🎨
            </div>
